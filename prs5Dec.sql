...
INSERT INTO `contact` VALUES (1,'03112019165047','L- 34 / 3B Sector, Saket Nagar','Madhya Pradesh','Bhopal','India','462024','9752675714','satvin.hayer@gmail.com'),(2,'05112019201744','L- 34 / 3B Sector, Saket Nagar','Madhya Pradesh','Betul','India','462024','9752675714','satvin.hayer@gmail.com');
...
INSERT INTO `eduoccupation` VALUES (1,'03112019165047','pgdiploma','selfemployed','manager','depmanager'),(2,'05112019201744','pgdiploma','privatejob','manager','manager');
...
INSERT INTO `medicine` VALUES (1,'Sizopin 100mg','Clozapine','Sun Pharma Industries Ltd.'),(3,'Sizopin 50mg','Clozapine','Sun Pharma Industries Ltd.'),(4,'Etizola 0.5mg','Etizolam','Macleods Pharmaceuticals Ltd.'),(5,'Zolfresh 10mg','Zolpidem','Abbott India Ltd.'),(6,'Stalopam 20mg','Escitalopram','Lupin Laboratories Ltd.'),(7,'Stalopam 10mg','Escitalopram','Lupin Laboratories Ltd.'),(8,'Lozapin 100mg','Clozapine','Torrent Labs (P) Ltd.');
/*!40000 ALTER TABLE `medicine` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `medicinepresc`
--

DROP TABLE IF EXISTS `medicinepresc`;
/*!50001 DROP VIEW IF EXISTS `medicinepresc`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `medicinepresc` AS SELECT 
 1 AS `idprescription`,
 1 AS `visitno`,
 1 AS `patientid`,
 1 AS `medicinename`,
...
INSERT INTO `personalinfo` VALUES (1,'03112019165047','Satvinder','Singh','1978-12-15','male','sonof','Gurcharan Singh','Single','40 Years'),(2,'05112019201744','ravindra','singh','1980-01-05','male','sonof','Gurcharan Singh','Married','38 Years');
...
INSERT INTO `prescription` VALUES (1,'Sizopin 100mg (Clozapine)','1 Tablet',':night','1','03112019165047','1'),(2,'Stalopam 20mg (Escitalopram)','1 Tablet','morning:night','2','03112019165047','1'),(3,'Stalopam 20mg (Escitalopram)','1 Tablet','morning:night','1','03112019165047','2'),(4,'Sizopin 100mg (Clozapine)','1 Tablet',':night','2','03112019165047','2'),(5,'Zolfresh 10mg (Zolpidem)','1 Tablet',':night','1','03112019165047','3'),(6,'Stalopam 20mg (Escitalopram)','1 Tablet','morning:night','2','03112019165047','3'),(7,'Sizopin 100mg (Clozapine)','1 Tablet',':night','1','05112019201744','1'),(8,'Zolfresh 10mg (Zolpidem)','1 Tablet',':night','2','05112019201744','1'),(9,'Stalopam 20mg (Escitalopram)','1 Tablet','morning','3','05112019201744','1');
/*!40000 ALTER TABLE `prescription` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `searchinfo`
--

DROP TABLE IF EXISTS `searchinfo`;
/*!50001 DROP VIEW IF EXISTS `searchinfo`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `searchinfo` AS SELECT 
 1 AS `idpersonalinfo`,
 1 AS `personalinfoid`,
 1 AS `relation`,
 1 AS `fname`,
...
INSERT INTO `userdata` VALUES (1,'satvin','satvin','Admin','Satvinder','02/12/2019','satvin1234@gmail.com','9752675714'),(2,'satvin123','satvin123','Admin','Satvinder Pal Singh','02/12/2019','satvin.hayer@gmail.com','09752675714'),(4,'ravin','ravin','Admin','ravindra','03/12/2019','ravindra.hayer@gmail.com','9752675714');
...
INSERT INTO `visitdata` VALUES (1,'1','03112019165047','03/11/2019','sasadad','sdadadasd','adadd','ada','ada','adadad','dadqa','dadad','dadad','adada','daad',' : Abnormal Behaviour : Irrelevant Talks : Declining Social & Friend Circle : Academic or Occupational Decline : Denying Illness despite Marked Impairment in Functioning : Headache',' : Personality Disorder : Post-Traumatic Stress Disorder : Psychosomatic Disorder : Psychotic Disorder : Relationship Problems'),(2,'2','03112019165047','04/11/2019','gdhgs','sdhhhs','hhdfhsh','dhs','hsh','dgdg','gggg','ggdgds','gdgd','ggddg','dgdg',' : Declining Social & Friend Circle : Academic or Occupational Decline : Denying Illness despite Marked Impairment in Functioning : Headache : Repeated Episode of Unconsciousness',' : Personality Disorder : Post-Traumatic Stress Disorder : Psychosomatic Disorder : Psychotic Disorder : Relationship Problems'),(3,'3','03112019165047','15/11/2019','asdadasd','dadadad','dadad','dad','dad','dad','dad','dad','dad','dadad','adadda',' : Muttering / Talking to Self : Laughing or Smiling Without Reason : Suspiciousness That Spouse is Not Faithful : Suspicious that Somebody is Trying to Harm Him : Suspicious about Someone is Conspiring Against Him',' : Post-Traumatic Stress Disorder : Psychosomatic Disorder : Psychotic Disorder : Relationship Problems : Schizophrenia'),(4,'1','05112019201744','19/11/2019','','','','110/80 mm/hg','80','normal','102 Deg Fhr','No Pain','Normal','','',' : Abnormal Behaviour : Irrelevant Talks : Declining Social & Friend Circle : Academic or Occupational Decline : Denying Illness despite Marked Impairment in Functioning',' : Dipression / Sadness : Dissociative Disorder : Eating Disorder : Headache : Marital Problems : Mood / Bipolar Disorder');
/*!40000 ALTER TABLE `visitdata` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Final view structure for view `medicinepresc`
--
...
/*!50001 VIEW `medicinepresc` AS select `a`.`idprescription` AS `idprescription`,`a`.`visitno` AS `visitno`,`a`.`patientid` AS `patientid`,`a`.`medicinename` AS `medicinename`,`a`.`dosage` AS `dosage`,`a`.`presctime` AS `presctime`,`b`.`idvisitdata` AS `idvisitdata`,`b`.`dateofvisit` AS `dateofvisit` from (`prescription` `a` join `visitdata` `b`) where ((`a`.`patientid` = `b`.`patientid`) and (`a`.`visitno` = `b`.`visitno`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `searchinfo`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `searchinfo` AS select `a`.`idpersonalinfo` AS `idpersonalinfo`,`a`.`personalinfoid` AS `personalinfoid`,`a`.`relation` AS `relation`,`a`.`fname` AS `fname`,`a`.`lname` AS `lname`,`a`.`dob` AS `dob`,`a`.`gender` AS `gender`,`a`.`rname` AS `rname`,`a`.`age` AS `age`,`b`.`city` AS `city`,`b`.`mobile` AS `mobile`,`b`.`email` AS `email` from (`personalinfo` `a` join `contact` `b`) where (`a`.`personalinfoid` = `b`.`personalinfoid`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2019-12-05 15:53:36
