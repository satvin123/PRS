CREATE DATABASE  IF NOT EXISTS `satvinso_prs` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `satvinso_prs`;
...
INSERT INTO `contact` VALUES (1,'21102019142220','L- 34 / 3B Sector, Saket Nagar','Madhya Pradesh','Bhopal','India','462024','9752675714','satvin.hayer@gmail.com');
...
INSERT INTO `eduoccupation` VALUES (1,'21102019142220','pgdiploma','selfemployed','software','notapplicable');
...
INSERT INTO `medicine` VALUES (1,'Sizopin 100mg','Clozapine','Sun Pharma Industries Ltd.'),(3,'Sizopin 50mg','Clozapine','Sun Pharma Industries Ltd.'),(4,'Etizola 0.5mg','Etizolam','Macleods Pharmaceuticals Ltd.'),(5,'Zolfresh 10mg','Zolpidem','Abbott India Ltd.'),(6,'Stalopam 20mg','Escitalopram','Lupin Laboratories Ltd.');
...
INSERT INTO `personalinfo` VALUES (1,'21102019142220','Satvinder Pal','Singh','1978-12-15','male','sonof','Gurcharan Singh','Single','40 Years');
...
INSERT INTO `prescription` VALUES (1,'Sizopin 100mg (Clozapine)','1 Tablet',':night','1','21102019142220','1'),(2,'Stalopam 20mg (Escitalopram)','1 Tablet','morning:night','2','21102019142220','1');
...
INSERT INTO `visitdata` VALUES (1,'1','21102019142220','21/10/2019 14:28:02','Satvinder Pal Singh','Satvinder Pal Singh','Satvinder Pal Singh','Satvinder Pal Singh','Satvinder Pal Singh','Satvinder Pal Singh','Satvinder Pal Singh','Satvinder Pal Singh','Satvinder Pal Singh','Satvinder Pal Singh','Satvinder Pal Singh',' : Lethargy or Weakness : Lack Of Concentration : Suicidal Ideation : Loneliness : Crying',' : Conversion Disorder / Hysteria : Dementia : Dipression / Sadness : Dissociative Disorder : Eating Disorder');
...
-- Dump completed on 2019-10-24 11:20:11
